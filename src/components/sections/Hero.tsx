    ...
    <section id="product" className="relative overflow-hidden">
      ...
      <div className="container mx-auto relative py-20 md:py-28">
        <div className="mx-auto max-w-3xl text-center animate-enter">
          ...
          <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-3">
            <Button variant="hero" size="lg" className="w-full sm:w-auto">
              <PlayCircle /> See it in action
            </Button>
            <Button variant="outline" size="lg" className="w-full sm:w-auto" asChild>
              <a href="#contact"><FileText /> Read one-pager</a>
            </Button>
          </div>
        ...
        <figure className="mt-16 md:mt-20 rounded-xl border bg-card/60 backdrop-blur shadow-elegant p-3">
          <img
            src="/lovable-uploads/67d330fe-e89b-4602-ba8e-ce9fb6c04409.png"
            alt="Stanza Health dashboard showcasing AI clinical insights, Stanza Scribe™, and population analytics"
            loading="lazy"
